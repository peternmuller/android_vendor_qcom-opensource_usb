...
ifneq ($(filter bengal monaco trinket pitti,$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter bengal kona lahaina taro blair kalama pineapple sun parrot monaco trinket tuna kera,$(TARGET_BOARD_PLATFORM)),)
